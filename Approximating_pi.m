...
%--- MONTE-CARLO METHOD ----
%---------------------------
% The main function is Approximating_pi() which basically apprimates the
...
% [calculted_pi, relative_error] = Approximating_pi(any proper integer value)
% in the command window.
%---------------------------

function [calculated_pi, calculated_error] = Approximating_pi(n)
